    ...
    return (
        <div className={classes.container}>
            <div className={classes.section1}>
                <h2 className={classes.title}>손쉽고 편리한 무인매장 관리</h2>
                <p className={classes.content}>Auto-Store는 매장을 옮겨 놓은 듯한 직관적인 UI를 제공합니다.</p>
                <p className={classes.content}>사용자가 원하는 곳에 직접 진열대를 위치시킬 수 있습니다.</p>
            </div>
