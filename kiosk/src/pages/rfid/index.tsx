...
export default function RFIDPage() {
  ...
  // 상품 수량이 0일 때 GIF와 텍스트 다시 나타나기
  useEffect(() => {
    if (totalQuantity === 0) {
      setFadeOut(false); // 총 수량이 0이면 GIF와 텍스트 다시 나타나기
    }
  }, [totalQuantity]);
  ...
  return (
    <div className={styles.pageContainer}>
      ...
      <div className={styles.productsContainer}>
        {scannedProducts.map((product, index) => (
          ...
          >
            ...
            />
            <span>{product.productName} & {product.barcode}</span>
      ...
      <div className={styles.summary}>
        ...
        <div className={styles.totalPrice}>총 결제금액: {formatPrice(totalPrice)}원</div>
      </div>
