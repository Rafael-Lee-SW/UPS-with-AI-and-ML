...
public enum ResponseEnum {
    ...
    INVALID_ROLE_TYPE(false, 5007, HttpStatus.BAD_REQUEST.value(), "해당 사용자의 직원 유형이 적절하지 않습니다."),
    //Product 오류
    ...
    //Store 오류
    WAREHOUSE_NOT_FOUND(false, 10000, HttpStatus.BAD_REQUEST.value(), "매장를 찾을수 없습니다."),
    WAREHOUSE_DELETED(false, 10001, HttpStatus.BAD_REQUEST.value(), "삭제된 매장 입니다."),
    INVALID_WAREHOUSE_TYPE(false, 10002, HttpStatus.BAD_REQUEST.value(),
        "해당 매장에 속해있는 로케이션들로 인해 warehouse의 타입을 변경할수 없습니다."),
